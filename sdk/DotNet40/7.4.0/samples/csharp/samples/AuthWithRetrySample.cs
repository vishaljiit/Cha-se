...
{
	/// <summary>
	/// Summary description for AuthSampleWithRetry.
	/// </summary>
	public class AuthWithRetrySample : IOrbitalSample
	{
		...
		public void RunTest(int testCaseNumber)
		{
			try
			{
                ...
                // Set the TraceNumber for this transaction
				// Trace number is added by SDK at run time to the trasnaction object and
				// moved into MIME-HEADER at process time
				transaction["TraceNumber"] = "100001";
