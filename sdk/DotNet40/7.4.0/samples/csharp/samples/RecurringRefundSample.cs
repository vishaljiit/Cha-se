...
{
	/// <summary>
	/// Summary description for RecurringRefundSample.
	/// </summary>
	public class RecurringRefundSample : IOrbitalSample
	{
		...
		public string Name
		{
			get
			{
				return "Recurring Refund Sample";
			}
		}
		// Run the test case
		public void RunTest(int testCaseNumber)
		{
			try
			{
				...
				transaction["Comments"] = "This is a Credit Card Recurring Refund";
