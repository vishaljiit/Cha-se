...
{
	/// <summary>
	/// Summary description for FlexCacheSample.
	/// </summary>
	public class FlexCacheSample : IOrbitalSample
	{
		...
		public void RunTest(int testCaseNumber)
		{
			try
			{
				...
				transaction["AccountNum"] = "6035718888880650404";
				transaction["IndustryType"] = "MO";
				transaction["OrderID"] = "1234567890123456789012";
				transaction["Amount"] = "100";
				transaction["FlexAction"] = "AUTH";
				transaction["Comments"] = "Test FlexCache Standalone Request";
