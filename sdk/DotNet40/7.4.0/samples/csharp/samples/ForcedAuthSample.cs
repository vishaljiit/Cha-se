...
{
	/// <summary>
	/// Summary description for ForcedAuthSample.
	/// </summary>
	public class ForcedAuthSample : IOrbitalSample
	{
		...
		public void RunTest(int testCaseNumber)
		{
			try
			{
				...
				transaction["Comments"] = "This is a test Credit Card Forced Auth";
