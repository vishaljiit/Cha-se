...
namespace ChasePaymentech.Orbital.Test.Samples
{
	...
	/// </summary>
	public class AuthSample : IOrbitalSample
	{	
		...
		public void RunTest(int testCaseNumber)
		{
			try
			{
                ...
                // If you are not configured for IP-based communication 
                // (using a hostname instead of IP Address),
                // Then you must set the connection username and password. 
                // Just uncomment the lines of code below, and set them to 
                // your actual username and password.
                //transaction[ "OrbitalConnectionUsername" ] = "YourUserName";
                //transaction[ "OrbitalConnectionPassword" ] = "YourPassword";
