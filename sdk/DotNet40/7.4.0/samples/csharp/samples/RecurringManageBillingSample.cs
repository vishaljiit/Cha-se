...
{
	/// <summary>
	/// Summary description for RecurringManageBillingSample.
	/// </summary>
	public class RecurringManageBillingSample : IOrbitalSample
	{
		...
		public string Name
		{
			get
			{
				return "Recurring Manage Billing Sample";
			}
		}
		// Run the test case
		public void RunTest(int testCaseNumber)
		{
			try
			{
				...
				transaction["Comments"] = "This is a Credit Card Recurring Auth";
				transaction["AVSzip"] = "33067";
				...
				transaction["MBRecurringMaxBillings"] = "3";
				transaction["MBRecurringFrequency"] = "? * MON";
